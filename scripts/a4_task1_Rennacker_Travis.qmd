...
**Columbia Basin Research, University of Washington. (2023). Columbia River DART (Data Access in Real Time). Retrieved January 25, 2023, from https://www.cbr.washington.edu/dart]**
...
- Create data frames for daily, weekly, yearly summation. 
- Original Time Series plot: ggplot with geom_line
- Seasonplot: create three plots for consistent and controlled aesthetic (use weekly summation for better understanding of seasonality over time)
