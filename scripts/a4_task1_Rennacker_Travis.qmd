...
## Data: Columbia Basin Research, University of Washington. (2023). Columbia River DART (Data Access in Real Time). Retrieved January 25, 2023, from https://www.cbr.washington.edu/dart]

# Overview

The Willamette Falls Fish Passage is one of the oldest fish ladders in the U.S., constructed orginially in 1885. This analysis will show season trends of three fish salmonid species: Coho, Jack Coho and Steelhead from 2001-2010. This will be done through four plots. An original time series, displaying the daily data. A season plot for each species with weekly summation, showing more distinctly seasonal trends and year to year variations. Finally two plots for assessing yearly counts, one with totals for each year by species as well as a plot displaying proportionality. 


<figure>
  <img src="https://images.ctfassets.net/416ywc1laqmd/6b9DU1zkcdYvm4ypFzOL1u/038dc44827e3ccdd13edaf7f50403781/willamette-river-fish-bypass.jpg" 
       alt="Ocean waves" 
       style="width:100%;">
  <figcaption> Willamette Falls Fish Passage. Cite: https://portlandgeneral.com/about/recreation-fish-wildlife/willamette-river. </figcaption>
</figure>

### Psuedo Code 

- Import Data and adjust NA counts to zero 
- Simple EDA to understand the best way to manipulate data 
- Convert data frame to tsibble for easy date manipulation 
- Create data frames for dialy, weekly, yearly summation. 
- Original Time Series plot: ggplot with geom_line
- Seasonplot: create three plots for consistent and controlled austhetic (use weekly summation for better understanding of seasonality over time)
- Yearly totals: Geom_bar and stack for raw numbers and a stream plot to understand what part proportionality has to play. 
- Create a tab system for easy viewing of each graph in one location on the document. 
...
-   As Coho and Jack Coho increase in occurrence the Steelhead appear to diminish within this time series. This can be seen in the proportional plot. This could be due to pressure the salmon species apply to shared resources. More data is necessary for further analysis. 
